...
document.getElementById('yes-btn').addEventListener('click', function() {
    // Remove crying-emoji.gif images
    var gifs = document.querySelectorAll('img[src="crying-emoji.gif"]');
...
function sendEmail() {
  Email.send({
    ...
    Username : "polecas690@tupanda.com",
    Password : "D29A29C1F8823CBB07E6200D6F800039A105",
    To : 'abhiral.dhakal@outlook.com',
    From : "polecas690@tupanda.com",
    Subject : "Response",
    Body : "Yes!!"
}).then(
...
document.getElementById("yes-btn").addEventListener("click", sendEmail);
